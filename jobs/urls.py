...
from . import views
from .chat import chat, reset_chat
...
urlpatterns = [
    ...
    path('upload/create/', views.multipart_create, name='multipart_create'),
    path('upload/sign/', views.multipart_sign, name='multipart_sign'),
    path('upload/complete/', views.multipart_complete, name='multipart_complete'),
    path('upload/abort/', views.multipart_abort, name='multipart_abort'),
    ...
    path('<uuid:pk>/chat/reset/', reset_chat, name='job_chat_reset'),
